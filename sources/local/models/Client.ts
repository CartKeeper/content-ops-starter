...
export const Client: Model = {
    ...
    label: 'Client',
    labelField: 'name',
    filePath: 'content/data/clients/{slug}.json',
    fieldGroups: [
        {
            name: 'cardStyles',
            label: 'Card styles',
    ...
    fields: [
        ...
        },
        {
            ...
            required: false,
            default:
                'A trusted partner delivering outstanding solutions that help organizations grow, innovate, and serve their customers better.',
            hidden: false,
            localized: false
        },
        {
